...
def preemptive_sjf(process_list: list):
    ...
    min_time_boundry = first_arrival_time
    max_time_boundry = min_time_boundry + 1
    ...
    for i in range(len(gantt_chart)):
        if (i == len(gantt_chart) - 1) or (gantt_chart[i] != gantt_chart[i+1]): 
            ...
            time_intervals[gantt_chart[i]].append([min_time_boundry, max_time_boundry])
            min_time_boundry = max_time_boundry
